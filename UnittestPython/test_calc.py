...
#Create class
class TestCalculation(unittest.TestCase): #A testcase is created by subclassing unittest.TestCase
    #each function is designed for testing needs to have the name with test_ at the beginning
    def test_add(self):
        #TestCase class provides several assert methods to check for and report failures
